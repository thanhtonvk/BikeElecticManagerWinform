...
GO
-- THEM SAN PHAM
CREATE PROCEDURE USP_THEMSP @MASP CHAR(10),@TENSP NVARCHAR(50),@MAU NVARCHAR(50),@THONGSO NVARCHAR(30),@GIABAN FLOAT
AS
BEGIN
    INSERT INTO SANPHAM VALUES(@MASP,@TENSP,@MAU,@THONGSO,@GIABAN)
END
GO
-- SUA SAN PHAM
CREATE PROCEDURE USP_SUASP  @MASP CHAR(10),@TENSP NVARCHAR(50),@MAU NVARCHAR(50),@THONGSO NVARCHAR(30),@GIABAN FLOAT
AS
BEGIN
    UPDATE SANPHAM SET TENSP = @TENSP,MAU = @MAU,THONGSO = @THONGSO,GIABAN = @GIABAN WHERE MASP = @MASP
END
GO
--XOA SAN PHAM
